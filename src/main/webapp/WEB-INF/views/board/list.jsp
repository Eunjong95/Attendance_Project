...
<%@ taglib prefix="paging" tagdir="/WEB-INF/tags" %>
<!DOCTYPE html>
<html>
	                                ...
	                                <div class="col-sm-12 col-md-1">
	                                   <div class="d-flex justify-content-center">
	                                      <table class="table" style="border-style: hidden">
				                          	<tr>
				                            	<td align="left">
				                                	<paging:paging boardCategoryId="${boardCategoryId}" totalPageCount="${totalPageCount}" nowPage="${page}"/>
				                                </td>
				                            </tr>
				                       	  </table>
	                                   </div>
