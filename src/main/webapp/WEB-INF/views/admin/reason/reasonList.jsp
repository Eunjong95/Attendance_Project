                                			...
                                			<div class="col-sm-12 col-md-6">
                                				<div class="d-flex justify-content-start">
	                                				<div id="dataTable_filter" class="dataTables_filter">
	                                					<label>강의명
	                                						<button class="btn btn btn-info" onclick="location.href='<c:url value="/reason/list/${reasonStatus}?lectureId=1"/>'">JAVA</button>
	                                						<button class="btn btn-dark" onclick="location.href='<c:url value="/reason/list/${reasonStatus}?lectureId=2"/>'">C언어</button>
	                                		 				<button class="btn btn-secondary" onclick="location.href='<c:url value="/reason/list/${reasonStatus}?lectureId=3"/>'">Python</button>
	                                					</label>
                                				...
                                				<table class="table table-bordered dataTable" id="dataTable"  cellspacing="0" role="grid" aria-describedby="dataTable_info" style="width: 100%;">
				                                    ...
				                                    <tbody> 
				                                    	...
				                                    	<c:forEach var="reason" items="${reasonList}">
				                                    		<tr onclick="location.href='<c:url value='/reason/view/${reason.reasonId}/${page}'/>'" style="cursor:pointer;">
                               				...
                               				<div class="col-sm-12 col-md-1">
                               					<div class="d-flex justify-content-center">
	                               					<table class="table">
														<tr>
															<td align="left">
																<reasonPaging:reasonPaging totalPageCount="${totalPageCount}" nowPage="${page}"/>
															</td>
														</tr>
													</table>
                               					</div>
