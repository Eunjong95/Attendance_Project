...
<%
	...
	if(nowPageBlock>1){
		out.print("<li>");
		out.print("<a href=\""+contextPath+"/reason/list/"+(startPage-1)+"\"aria-label=\"Previous\">");
	...
	for(int i=startPage; i<=endPage;i++){
		...
		out.print("<a href=\""+contextPath+"/reason/list/"+(i)+"\">");
	...
	if(nowPageBlock < totalPageBlock) {
		out.print("<li>");
		out.print("<a href=\""+contextPath+ "/reason/list/"+(endPage+1)+"\" aria-label=\"Next\">");
		out.print("<button class='btn btn-primary'style='color:white'>");
		out.print("Next");
		out.print("</button>");
		out.print("</a>");
